...
func main() {
	...
	router.HandleFunc("/api/v1/statement", handlers.PrepareStatement).Methods("POST")
	router.HandleFunc("/api/v1/statement/query", handlers.SelectStatement).Methods("GET")
	router.HandleFunc("/api/v1/statement/query", handlers.ExecuteStatement).Methods("POST")
	router.HandleFunc("/api/v1/statement", handlers.CloseStatement).Methods("DELETE")
