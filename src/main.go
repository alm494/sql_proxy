...
func main() {
	...
	router.HandleFunc("/api/v1/prepared/query", handlers.PreparedSelect).Methods("GET")
	router.HandleFunc("/api/v1/prepared/query", handlers.PreparedExecute).Methods("POST")
